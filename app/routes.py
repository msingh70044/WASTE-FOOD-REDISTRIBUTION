...
from . import app, db
from .forms import RestaurantFoodForm, NGOReceiveForm, FundDonorForm, RestaurantRegisterForm, NGORegisterForm, DonorRegisterForm, FeedbackForm
from .models import FoodItem, FundDonor, Feedback
...
def admin_dashboard():
    ...
    unread_feedback_count = Feedback.query.filter_by(read=False).count()
...
def delete_donor(donor_id):
    donor = FundDonor.query.get(donor_id)
    if donor:
